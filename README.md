...
- Since the LLM is text-only, and position information isn't exposed by Diambra for RL training purposes, we must use a YOLO model fine-tuned on [synthetic scenes of actual character sprites](#yolo) to get around these limitations.
