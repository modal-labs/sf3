# called inside src.training.qwen3.py::train_model
...
def parse_args():
    ...
    parser.add_argument("--bs_per_device", type=int, required=True)
...
def main():
    ...
    # https://huggingface.co/docs/trl/main/en/kto_trainer#imbalanced-data
    ...
    logging_steps = max(1, args.max_steps // 100)
    ...
    training_args = KTOConfig(
        ...
        per_device_eval_batch_size=args.bs_per_device,
        # save
        save_strategy="steps",
